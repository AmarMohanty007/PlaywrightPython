"""
Playwright table and assignment lesson covering dynamic tables, pagination, filters, and flight-booking scenarios. This file focuses on paginationtable assignment.
"""

from playwright.sync_api import expect, Page

# Test case covering the pagination table lab print all data from paginated table scenario.
