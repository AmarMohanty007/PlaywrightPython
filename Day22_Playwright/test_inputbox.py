"""
Playwright form-controls lesson covering input boxes, checkboxes, radio buttons, and element assertions. This file focuses on inputbox.
"""

import pytest
from playwright.sync_api import Page, expect

# Test case covering the inputbox scenario.
