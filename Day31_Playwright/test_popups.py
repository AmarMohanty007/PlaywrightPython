"""
Playwright browser-context lesson covering tabs, popups, authentication popups, and multi-page assertions. This file focuses on popups.
"""

from playwright.sync_api import sync_playwright, expect, Playwright

# Test case covering the hande popups scenario.
