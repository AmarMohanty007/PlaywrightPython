"""
Reusable data readers for JSON, CSV, and Excel test data used by data-driven Playwright tests.
"""
...
# Helper function that reads read json data.
...
# Helper function that reads read csv data.
...
# Helper function that reads read excel data.
