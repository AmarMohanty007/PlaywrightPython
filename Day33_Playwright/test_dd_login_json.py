"""
Playwright data-driven testing lesson using inline data, JSON, CSV, Excel, and shared data-reader utilities. This file focuses on data driven login json.
"""
...
# Test case covering the login data driven json scenario.
