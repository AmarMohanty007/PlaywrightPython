"""
Python strings and mutability lesson covering string methods, assignments, and object behavior. This file focuses on stringmethodspart2.
"""
...
#   list of delimiters  -  space, @, #, & ( ) _ ; :


# #Example1
# s="Hi,Sunita,How,was,your,day"
# lst=s.split(",")
# print(type(lst))  #list
