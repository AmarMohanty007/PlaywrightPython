"""
Playwright introduction covering browser launch, page navigation, sync and async tests, and basic assertions. This file focuses on playwright async.
"""
...
# Test case covering the verifyPageUrl async scenario.
@pytest.mark.asyncio
